...
```{r}
eg.bio <- read.csv("Data/Eelgrass_metrics/Eelgrass_biometrics_2018_RAW.csv", header = TRUE, stringsAsFactors = FALSE)

eg.tran <- read.csv("Data/Eelgrass_metrics/Eelgrass_transect_2018_RAW.csv", header = TRUE, stringsAsFactors = FALSE)
