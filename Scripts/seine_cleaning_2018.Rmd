...
```{r data}
seine <- read.csv(url("https://knb.ecoinformatics.org/knb/d1/mn/v2/object/urn%3Auuid%3A0475361b-5d7a-4991-8692-725158dc733a"), stringsAsFactors = FALSE, header = TRUE) # read in WR seines
seine_trial <- read.csv(url("https://knb.ecoinformatics.org/knb/d1/mn/v2/object/urn%3Auuid%3A1463f7d8-92aa-40aa-8ae7-f89761c79671"), stringsAsFactors = FALSE, header = TRUE) # read in trial exp data
