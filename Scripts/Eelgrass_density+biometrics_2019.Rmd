...
```{r}
eg.bio <- read.csv("Data/Eelgrass_metrics/Eelgrass_biometrics_2019_clean.csv", header = TRUE, stringsAsFactors = FALSE)

eg.tran <- read.csv("Data/Eelgrass_metrics/Eelgrass_transect_2019_RAW.csv", header = TRUE, stringsAsFactors = FALSE)
