...
eg.site <- read.csv("Data/Eelgrass_metrics/seagrass_site_2017_RAW.csv", stringsAsFactors = FALSE, header = TRUE)
...
eg.bio <- read.csv("Data/Eelgrass_metrics/seagrass_biometrics_CLEAN.csv", stringsAsFactors = FALSE, header = TRUE)

# Eelgrass Transect (quadrat level)
eg.tran <- read.csv("Data/Eelgrass_metrics/seagrass_transect_2017_RAW.csv", stringsAsFactors = FALSE, header = TRUE)
```
